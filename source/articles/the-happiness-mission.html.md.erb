...
description: |
  I make an initial attempt at describing the mission for Wossname Industries: to measurably improve your long term happiness!
...
related:
  - title: The Happiness Manifesto
    url: /articles/the-happiness-manifesto/
    description: |
      I go into a bit more depth here about what the mission actually means, and start developing the ideas into a manifesto by which Wossname Industries should live.
...
tags:
  ...
  - Measuring Happiness
---
I'm currently working my way through the [Happy Startup School](http://www.thehappystartupschool.com/)'s course on building the sort of company you wouldn't want to sell. I've been toying with the idea for several months now that there's something interesting around the intersection of technology and mental health. I reckon that there are ways in which we can make a positive difference to many people's lives by exploring that intersection.  I'm also hoping that I can make a sustainable income out of it, too!

One of the early tasks in the Startup School programme is to define the company's mission. This should be short and sweet &mdash; concise enough to fit into a Tweet &mdash; but provide an over-arching direction the company is heading in. I'm thinking of it being like the [plot arc](https://en.wikipedia.org/wiki/Story_arc) for a season of a television show. Here's what I came up with:
...
* While the initial focus of our ideas is around improving mental wellness on an **individual** level, I think there are interesting things we can do to holistically improve happiness for **entire organisations** &mdash; which could be companies, social groups, families, or even online communities.
